...
int main (int argc,char * argv [])
{
  ...
  cout << "Time taken to build index using BST is: " << total_t << endl;
  cout << "Height of BST Tree is: " << BST.depth()<< endl;
  ...
  while(options)
      ...
      else if (options == 2)
	{
	  ...
	  cin >> SearchWord;
	  if (BST.contains(SearchWord)== true)
	    {

	      cout << "Line numbers<BST>: ";
 breakup (line, cout	      vector<int> rows = BST.getLines(SearchWord);
